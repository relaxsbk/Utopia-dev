            ...
            @foreach ($orders as $order)
                <tr>
                    ...
                    <td>
                        <form method="POST" action="{{ route('admin.orders.updateStatus', $order) }}">
                            ...
                            <div class="input-group">
                                <x-adminlte-select class="form-select btn-sm" name="status" onchange="this.form.submit()">
                    ...
                    <td>
                        ...
                        <x-adminlte-button label="Подробнее" data-toggle="modal" data-target="#orderModal-{{ $order->id }}" class="btn btn-sm btn-info" />
                    </td>
                </tr>
